...
<head>
	...
	<script type="text/javascript">
		...
		function createQueryList(){
			...
			document.write('<table class="items_table" frame="box" style="border-color:#DDDDDD; border-style: solid; border-width: 2px;" rules="all">');
			document.write('<tr>');
			document.write('<th style="border-width:2px; border-color:#DDDDDD;">Index</th>');
			document.write('<th style="border-width:2px; border-color:#DDDDDD;">Photo</th>');
			document.write('<th style="border-width:2px; border-color:#DDDDDD;">Name</th>');
			document.write('<th style="border-width:2px; border-color:#DDDDDD;">Price</th>');
			document.write('<th style="border-width:2px; border-color:#DDDDDD;">Zip code</th>');
			document.write('<th style="border-width:2px; border-color:#DDDDDD;">Condition</th>');
			document.write('<th style="border-width:2px; border-color:#DDDDDD;">Shipping Option</th>');
			document.write('</tr>');
			...
			for (var idx = 0; idx < query_item_count; idx++){
				...
				document.write('<tr>');
				document.write('<td style="border-width:2px; border-color:#DDDDDD;">' + (idx+1) + '</td>');
				document.write('<td style="border-width:2px; border-color:#DDDDDD;" width="100px"><img src="' + query_items[idx]['galleryURL'][0] + '"></td>');
				document.write('<td style="border-width:2px; border-color:#DDDDDD;"><a href="' + rooturl + paras + app_itemID + '">' + query_items[idx]['title'][0] + '</a></td>');
				document.write('<td style="border-width:2px; border-color:#DDDDDD;">$' + query_items[idx]['sellingStatus'][0]['currentPrice'][0]['__value__'] + '</td>');
				if (query_items[idx]['postalCode'] == undefined || query_items[idx]['postalCode'][0] == ''){
					document.write('<td style="border-width:2px; border-color:#DDDDDD;">N/A</td>');
				}else{
					document.write('<td style="border-width:2px; border-color:#DDDDDD;">' + query_items[idx]['postalCode'][0] + '</td>');
				}
				if (query_items[idx]['condition'] == undefined || query_items[idx]['condition'][0]['conditionDisplayName'] == undefined || query_items[idx]['condition'][0]['conditionDisplayName'][0] == ''){
					...
					document.write('<td style="border-width:2px; border-color:#DDDDDD;">' + query_items[idx]['condition'][0]['conditionDisplayName'][0] + '</td>');
				}
				...
				if (query_items[idx]['shippingInfo'] == undefined || query_items[idx]['shippingInfo'][0]['shippingServiceCost'] == undefined || query_items[idx]['shippingInfo'][0]['shippingServiceCost'][0]['__value__'] == undefined || query_items[idx]['shippingInfo'][0]['shippingServiceCost'][0]['__value__'] == ''){
					...
					document.write('<td style="border-width:2px; border-color:#DDDDDD;">Free Shipping</td>');
				}else{
					document.write('<td style="border-width:2px; border-color:#DDDDDD;">$' + query_items[idx]['shippingInfo'][0]['shippingServiceCost'][0]['__value__'] + '</td>');
				}
				document.write("</tr>");
			}
		...
		function drawItemDetails(){
			...
			document.write('<div class="item_detail_div">Item Details</div>');
			document.write('<div class="detail_table"><table frame="box" style="border-color:#DDDDDD; border-style: solid; border-width: 2px;" rules="all" class="table_class">');
			var detail_list = '';
			if (jobj['Item']['ItemSpecifics'] != undefined && jobj['Item']['ItemSpecifics']['NameValueList'] != undefined){
				detail_list = jobj['Item']['ItemSpecifics']['NameValueList'];
			}
			var img_tmp = jobj['Item']['PictureURL'][0];
			if (img_tmp != ''){
				document.write('<tr><td style="border-width:2px; border-color:#DDDDDD;"><div class="space2left"><b>Photo</b></div></td>');
				document.write('<td style="border-width:2px; border-color:#DDDDDD;"><div class="space2left"><img width="100px" src="' + img_tmp + '"></div></td></tr>');
			}
			var title_tmp =  jobj['Item']['Title'];
			if (title_tmp != ''){
				document.write('<tr><td style="border-width:2px; border-color:#DDDDDD;"><div class="space2left"><b>Title</b></div></td>');
				document.write('<td style="border-width:2px; border-color:#DDDDDD;"><div class="space2left">' + title_tmp + '</div></td></tr>');
			}
			var subtitle_tmp =  jobj['Item']['Subtitle'];
			if (subtitle_tmp != ''){
				document.write('<tr><td style="border-width:2px; border-color:#DDDDDD;"><div class="space2left"><b>Subtitle</b></div></td>');
				document.write('<td style="border-width:2px; border-color:#DDDDDD;"><div class="space2left">' + subtitle_tmp + '</div></td></tr>');
			}
			var price_tmp =  jobj['Item']['CurrentPrice']['Value'];
			if (price_tmp != ''){
				document.write('<tr><td style="border-width:2px; border-color:#DDDDDD;"><div class="space2left"><b>Price</b></div></td>');
				var price_name = jobj['Item']['CurrentPrice']['CurrencyID']
				document.write('<td style="border-width:2px; border-color:#DDDDDD;"><div class="space2left">' + price_tmp + ' ' + price_name + '</div></td></tr>');
			}
			...
			if (location_tmp != ''){
				...
				document.write('<tr><td style="border-width:2px; border-color:#DDDDDD;"><div class="space2left"><b>Location</b></div></td>');
				document.write('<td style="border-width:2px; border-color:#DDDDDD;"><div class="space2left">' + location_tmp + postalcode_tmp + '</div></td></tr>');
			}
			var seller_tmp =  jobj['Item']['Seller']['UserID'];
			if (seller_tmp != ''){
				document.write('<tr><td style="border-width:2px; border-color:#DDDDDD;"><div class="space2left"><b>Seller</b></div></td>');
				document.write('<td style="border-width:2px; border-color:#DDDDDD;"><div class="space2left">' + seller_tmp + '</div></td></tr>');
			}
			var return_tmp =  jobj['Item']['ReturnPolicy']['ReturnsAccepted'];
			if (return_tmp != ''){
				document.write('<tr><td style="border-width:2px; border-color:#DDDDDD;"><div class="space2left"><b>Return Policy(US)</b></div></td>');
				document.write('<td style="border-width:2px; border-color:#DDDDDD;"><div class="space2left">' + return_tmp + '</div></td></tr>');
			}
			for (var i=0; detail_list != '' && i<detail_list.length; i++){
				document.write('<tr>');
				document.write('<td style="border-width:2px; border-color:#DDDDDD;"><div class="space2left"><b>' + detail_list[i]['Name'] + '</b></div></td>');
				document.write('<td style="border-width:2px; border-color:#DDDDDD;"><div class="space2left">');
				document.write(detail_list[i]['Value'][0] + '<br>')
				document.write('</div></td>');
				document.write('</tr>');
			}
			if (detail_list == ''){
				document.write('<tr>');
				document.write('<td style="border-width:2px; border-color:#DDDDDD;"><div class="space2left"><b>No Detail Info from Seller</b></div></td>');
				document.write('<td style="border-width:2px; border-color:#DDDDDD; background-color: #DDDDDD;"><div class="space2left"></div></td></tr>');
				document.write('</tr>');
		...
		function changeArrows(name){
			...
			if (document.getElementById(name).src.includes('up')){
				...
				if (name == 'arrow1'){
					...
					if (document.getElementById('arrow1').src.includes('up')){
						changeArrows('arrow1');
					}
		...
		function setSimilarContent(){
			...
			var content = '';
			if (item_count == 0){
				content = '<html><body><div style="height:20px; border-style:solid; border-width:1px; border-color:#DDDDDD; width:950px; margin: 0 auto; text-align:center; display: block;"><b>No Similar Item found.</b></div></body></html>';
				none_similar = true;
			}else{
				var computed_width = item_count*220;
				content += '<html><script>function jumpPage(url){window.top.location.href = url;}<\/script><body style="width:'+computed_width+'px"><div style="width='+computed_width+'px; margin:0 auto; text-align:center;">';
				...
				for (var i=0; i<item_count; i++){
					content += '<td><img src="' + items[i]['imageURL'] + '"></td>';
				}
				content += '</tr>';
				content += '<tr>';
				for (var i=0; i<item_count; i++){
					content += '<td><a href="" style="text-decoration: none; color: black;" onclick="jumpPage(\'';
					content += rooturl+similar_redirect+items[i]['itemId'];
					content += '\')">';
					content += items[i]['title'] + '</a></td>'
				}
				content += '</tr>';
				content += '<tr>';
				for (var i=0; i<item_count; i++){
					content += '<td><b>$' + items[i]['buyItNowPrice']['__value__'] + '</b></td>';
				}
				content += '</tr>';
